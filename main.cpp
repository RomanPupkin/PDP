...
int main() 
{
    ...
    //paramsFirst[0] =  0.080453;
    //paramsFirst[1] = 0.110633;
    //paramsFirst[2] = 2.868810;
    //paramsFirst[3] = 11.136400;
    //paramsFirst[4] = 1.191740;
    //paramsFirst[5] = 3.030110;
    //enCon.baseLen = 4.057110;
    //std::vector<std::vector<double>> TestgoodParams;
    //double res = sqFirst(gck, TestgoodParams, paramsFirst, enCon);
    //std::cout << "RES_TEST_1 = " << res << std::endl;
    // TEST
    //enCon.baseLen = 3.614;
    //enCon.E_c = 4.395;
    //enCon.E_on = -1.04;
    ...
    //paramsFirst[3] = 10.96;
    //paramsFirst[4] = 2.278;
    //paramsFirst[5] = 1.2240;
    //std::vector<std::vector<double>> TestgoodParams;
    //double res = sqFirst(gck, TestgoodParams, paramsFirst, enCon);
    //TestgoodParams.push_back(paramsFirst);
    //std::cout << "RES_TEST_1 = " << res << std::endl;
//
    //paramsFirst[0] = -1.905;
    //paramsFirst[1] = -0.049;
    ...
    //paramsFirst[3] = 8.183;
    //paramsFirst[4] = 3.344;
    //paramsFirst[5] = 0.7356;
    //res = sqSecond(gck, TestgoodParams, paramsFirst, enCon);
    //TestgoodParams.push_back(paramsFirst);
    //std::cout << "RES_TEST_2 = " << res << std::endl;
//
    //paramsFirst[0] = -0.852;
    //paramsFirst[1] = 0.139;
    //paramsFirst[2] = 2.378;
    //paramsFirst[3] = 7.679;
    //paramsFirst[4] = 2.139;
    //paramsFirst[5] = 1.5247;
    //res = sqThird(gck, TestgoodParams, paramsFirst, enCon);
    //std::cout << "RES_TEST_3 = " << res << std::endl;
